...
$err=array();
	...
	$get_banner="SELECT sc.*, csu.email from `cs_share_clicked` as sc, `cs_users` as csu WHERE csu.id=sc.shared_by and csu.client_id='".$_SESSION['admin_id']."' ";
	
	if(isset($_GET['header_search']) && $_GET['header_search']!='' )		
	{
		$get_banner.= " and (url like '%".re_db_input($_GET['header_search'])."%' || email like '%".re_db_input($_GET['header_search'])."%' || clicked_by like '%".re_db_input($_GET['header_search'])."%'  )";
	}
...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
        <ol class="breadcrumb">
            <li>YOU ARE HERE</li>
            <li class="active">Share Links</li>
        </ol>
        <h1 class="page-title">Share - <span class="fw-semi-bold">Links</span></h1>
        <div class="row">
            <div class="col-md-12">
                <section class="widget">
                    <header>
                        <h5>Shared Links<span class="fw-semi-bold"> Listing</span></h5>
                                ...
                                <?php if(re_db_num_rows($res_banner)>0)
                                {
                                    ...
                                    {	 
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo re_db_output($row_banner['clicked_by']); ?></td>
