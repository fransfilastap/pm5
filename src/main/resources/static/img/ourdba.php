...
*/
 ...
 $ACCESS_PWD='cs_pmapsw'; #script access password, SET IT if you want to protect script from public access
 ...
 'user'=>"cg_gen",#required



 'pwd'=>"cs111222", #required



 'db'=>"cs",  #default DB, optional
